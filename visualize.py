...
def visualization(ax, state, covariance, last_state, mode="init"):
    if mode == "init":
        ...
        ax.scatter3D(state[6::3], state[7::3], state[8::3], c="b", marker="x", label="Markers")
        ax.scatter3D(state[3], state[4], state[5], c="pink", marker=">", label="Markers")
    elif mode == "pred":
        ax.scatter3D(state[0], state[1], state[2], c="r", marker="1", label="Predicted Pose")
        ax.scatter3D(state[6::3], state[7::3], state[8::3], c="k", marker="x", label="Predicted Markers")
        ...
        ax.scatter3D(state[6::3], state[7::3], state[8::3], c="y", marker="o", label="Updated Markers")
